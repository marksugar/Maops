...
curl -Lks4 https://raw.githubusercontent.com/marksugar/Maops/master/nmp/nginx.conf -o /etc/nginx/nginx.cnf
curl -Lks4 https://raw.githubusercontent.com/marksugar/Maops/master/nmp/nginx -o $itt/nginx && chmod +x $itt/nginx
